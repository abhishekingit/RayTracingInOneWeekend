...
int main() {
	...
	auto material_glassSphere = std::make_shared<dielectric>(1.31);
	...
	world.add(std::make_shared<sphere>(point3(1.0, 0.7, -3.0), 1.0, material_glassSphere));
	...
	world.add(std::make_shared<sphere>(point3(0.5, 0, 1.0), 0.8, material_metalSphere2));
